...
<div class="card mb-4">
    <div class="card-body">
        <form action="<?php echo e(route('reports.monthly')); ?>" method="GET" class="row g-3 align-items-end">
            <div class="col-md-3">
...
<div class="row g-4 mb-4">
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h3><?php echo e($currency); ?><?php echo e(number_format($summary['average_sale'], 2)); ?></h3>
                <p>Average Sale</p>
            </div>
        </div>
    </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $paymentMethodSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <span class="badge bg-<?php echo e($payment->payment_method === 'cash' ? 'success' : ($payment->payment_method === 'card' ? 'primary' : 'info')); ?>">
                                            <?php echo e(ucfirst($payment->payment_method)); ?>

                                        </span>
                                    </td>
                                    <td class="text-end"><?php echo e($payment->count); ?></td>
                                    <td class="text-end fw-semibold"><?php echo e($currency); ?><?php echo e(number_format($payment->total, 2)); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="3" class="text-center text-muted py-3">No sales data</td>
...
<script>
    ...
    const dailyData = <?php echo json_encode($dailySales, 15, 512) ?>;
    const categoryData = <?php echo json_encode($categoryWiseSales, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mukul\workspace\pos\resources\views/reports/monthly.blade.php ENDPATH**/ ?>