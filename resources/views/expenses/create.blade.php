                ...
                <form action="{{ route('expenses.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                               value="{{ old('title') }}" placeholder="e.g., Monthly rent payment" required>
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="notes" class="form-control" rows="3" placeholder="Optional details">{{ old('notes') }}</textarea>
                    </div>
